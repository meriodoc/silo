...
// at the very beginning of OrderScreen I need to load data NB
...
export const orderPayReducer = (state = {}, action) => {
  switch (action.type) {
    ...
    case ORDER_PAY_FAIL:
      return { loading: false, error: action.payload };
    // Return default state = empty object
...
// ORDER MINE LIST REDUCER
export const orderMineListReducer = (state = { orders: [] }, action) => {
  // Switch case value = action.type
  switch (action.type) {
